...
# 原理：https://github.com/FDUCSLG/fducslg/blob/master/content/blog/2020-11-23-PAFD-EXPLAINED.md
...
class Fudan:
    ...
    def login(self):
        ...
        # 获取登录页上的令牌
        result = re.compile('<input type="hidden" name="(\w+)" value="(\S+)"').findall(page_login)
        # result 是一个列表，列表中的每一项是包含 name 和 value 的 tuple，例如 [('lt',
        # 'LT-6711210-Ia3WttcMvLBWNBygRNHdNzHzB49jlQ1602983174755-7xmC-cas'), ('dllt', 'userNamePasswordLogin'),
        # ('execution', 'e1s1'), ('_eventId', 'submit'), ('rmShown', '1')]
        data.update(
            result
        )
...
if __name__ == '__main__':
    ...
    # }
    # url_login = 'https://uis.fudan.edu.cn/authserver/login'
    # response = requests.get(url_login, headers=headers).text
    # print(response)
    # html = etree.HTML(response)
    # res = html.xpath('//form/input[@type="hidden"]/@value')
    # print(res)
    #
    #
    # data = {
    ...
    #     "service": "https://zlapp.fudan.edu.cn/site/ncov/fudanDaily"
    # }
    # result = [('lt', 'LT-6711210-Ia3WttcMvLBWNBygRNHdNzHzB49jlQ1602983174755-7xmC-cas')]
    # data.update(
    #     result
    # )
    # print(data)
