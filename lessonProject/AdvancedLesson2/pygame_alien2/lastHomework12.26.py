import sys
import pygame
from AdvancedLesson2.pygame_alien1.settings import Settings
from AdvancedLesson2.pygame_alien1.ship import Ship
...
def run_game():
    ...
    while True:
        ...
        if ship_move_right and ship.ship_rect.right < screen_rect.right:
            ship.ship_rect.centerx += 1
        if ship_move_left and ship.ship_rect.left > 0:
            ship.ship_rect.centerx -= 1
